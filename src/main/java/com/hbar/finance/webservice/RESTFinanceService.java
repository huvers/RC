...
public interface RESTFinanceService {
	public Response dateAlignedBasicEquityData(String targetTickerId, String signalTickerIds, String startDate, String endDate, String equityDataSourceId) throws Exception;
